# 📦 projects - Installation Protocol
...
```
projects Installed Successfully!
...
Features:
  ...
  Duration tracking (synergy with git-commit)
...
4. **Duration Tracking** - Parses time from git-commit messages, accumulates per project
...
- Duration tracking works best with git-commit installed
