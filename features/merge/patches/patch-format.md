...
6. **Template placeholders** — if the target repo uses `<ai-name>`/`<your-name>` placeholders and the user has personalized their files, note this in the patch so the AI can adapt FIND text
